...
//２．データ表示SQL作成
//新しい日付順に抽出するSQL
$stmt = $pdo->prepare("SELECT * FROM gs_test_table ORDER BY indate ASC;");
...
<header>
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="select.php">データ一覧に戻る</a>
      </div>
    </div>
  </nav>
</header>
...
<div align="center">
    ...
    <table>
        ...
        <input type="submit" name="ascending" value="登録日付昇順に並び替え">
        </form>
        </td>

        <td>
        <form method="post" action="select.php">
        <input type="submit" name="default" value="元の順に戻す">
        </form>
        </td>
        </tr>
    </table>
...
//２．データ表示SQL作成
$stmt = $pdo->prepare("SELECT * , count(*) from gs_test_table GROUP BY sdate ORDER BY indate ASC;");
